    ...
    switch (type) {
        ...
        case "check":
            return (
                <div
                    role="menuitem"
                    className={`velocity-menu-item ${disabled ? ContextMenuClasses.disabled : ""} ${ContextMenuClasses.item} ${ContextMenuClasses.labelContainer} ${
                        ContextMenuClasses[`color${color || "Default"}`]
                    }`}
                    onClick={(e) => {
