...
export const showConfirmationModal = (options = {}) => {
    ...
    return ModalActions.openModal((props) => (
        <ModalElements.ModalRoot {...props}>
            ...
            <ModalElements.ModalContent className="velocity-modal-content">
                {typeof content == "string" ? <Markdown className="velocity-modal-content">{content}</Markdown> : content}
            </ModalElements.ModalContent>
